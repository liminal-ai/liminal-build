...
- latest_response_path: /Users/leemoore/code/liminal-build/docs/spec-build/v2/epics/06--source-attachments-and-canonical-source-management/artifacts/quick-fix/002-quick-fix.json
...
nextIntent:
  ...
  summary: "Verifier returned revise with one blocking, quick-fix-scoped finding: the client bootstrap masks provenance API failures as a genuine empty provenance state. The smallest safe next action is to remediate that specific failure path before re-verification."
  artifactRef: "/Users/leemoore/code/liminal-build/docs/spec-build/v2/epics/06--source-attachments-and-canonical-source-management/artifacts/quick-fix/002-quick-fix.json"
replayBoundary: null
updatedAt: "2026-05-04T22:08:58.436Z"
```
