...
function buildDurableCheckpointStore(args: {
  ...
  return new InMemoryPlatformStore({
    ...
    artifactVersionsByArtifactId: {
      [materialArtifact.artifactId]: [
        {
          versionId: `${materialArtifact.artifactId}:version-1`,
          artifactId: materialArtifact.artifactId,
          versionLabel: materialArtifact.currentVersionLabel ?? 'draft-3',
          contentStorageId: `${materialArtifact.artifactId}:storage`,
          contentKind: 'markdown',
          bytes: 32,
          createdAt: materialArtifact.updatedAt,
          createdByProcessId: args.processSummary.processId,
        },
      ],
    },
    sourceAttachmentsByProjectId: {
      [args.projectSummary.projectId]: [
        buildSourceAttachmentSummaryFixture({
          ...
          repositoryUrl: materialSource.repositoryUrl,
