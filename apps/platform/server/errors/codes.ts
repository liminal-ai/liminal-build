export const notImplementedErrorCode = 'NOT_IMPLEMENTED' as const;
export const internalServerErrorCode = 'INTERNAL_SERVER_ERROR' as const;

export const processEnvironmentNotRecoverableErrorCode =
  'PROCESS_ENVIRONMENT_NOT_RECOVERABLE' as const;
...
export const processForbiddenErrorCode = 'PROCESS_FORBIDDEN' as const;
export const sourceAttachmentNotFoundErrorCode = 'SOURCE_ATTACHMENT_NOT_FOUND' as const;
export const sourceAttachmentConflictErrorCode = 'SOURCE_ATTACHMENT_CONFLICT' as const;
export const sourceAttachmentRefreshNotAvailableErrorCode =
